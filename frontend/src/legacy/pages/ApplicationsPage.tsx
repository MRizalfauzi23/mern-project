...
export function ApplicationsPage() {
  ...
  const resolveErrorMessage = (error: any) => error?.response?.data?.message;
  ...
  const createMutation = useMutation({
    ...
    onError: (error) => {
      const message = resolveErrorMessage(error) || "Gagal membuat lamaran";
  ...
  return (
    <section className="jobs-page">
          ...
          <div className="filter-row">
            <Select
              ...
              onValueChange={(value) => {
                ...
                setStatus(nextValue === "all" ? "" : nextValue);
              }}
            >
      ...
      {appsQuery.isError && <ErrorState message={resolveErrorMessage(appsQuery.error)} />}
              ...
              <span>Lowongan</span>
                <Select
                  ...
                  onValueChange={(value) => {
                    ...
                    setForm((prev) => ({
                      ...prev,
                      jobId: nextValue === "none" ? "" : nextValue
                    }));
                  }}
                >

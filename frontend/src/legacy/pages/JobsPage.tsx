...
export function JobsPage() {
  ...
  const updateMutation = useMutation({
    ...
    onError: (error) => {
      const message = (error as any)?.response?.data?.message || "Failed to update job";
      setActionError(message);
  ...
  const deleteMutation = useMutation({
    ...
    onError: (error) => {
      const message = (error as any)?.response?.data?.message || "Failed to delete job";
      setActionError(message);
  ...
  return (
    <section className="jobs-page">
      ...
      {query.isError && <ErrorState message={(query.error as any)?.response?.data?.message} />}
